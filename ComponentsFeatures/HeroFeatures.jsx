...
export default function HeroFeatures() {
  return (
    ...
    <div className="flex flex-col md:flex-row h-auto md:h-[700] md:w-[1600] bg-[#1C1E53] md:justify-center gap-10 md:gap-7 px-6 md:px-0 py-10 md:py-0">
      <div className="order-1 md:order-2 w-full md:w-[638] h-[250] md:h-[361] mt-0 md:mt-30 flex justify-center items-center relative">
        <SvgIcon2 />
      ...
      <div className="order-2 md:order-1 w-full md:w-[582] h-auto md:h-[414] mt-0 md:mt-30">
        <div>
