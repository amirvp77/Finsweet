...
export default function Team() {
  return (
    <>
      <div className="w-full md:w-[1600] h-auto md:h-[712] bg-[#F4F6FC] mt-10 md:mt-20 flex flex-col items-center justify-center gap-8 md:gap-12 px-6 md:px-0 py-10 md:py-0">
