    ...
    <>
      <div className="w-full md:w-[1280] h-auto md:h-[624] m-auto flex flex-col justify-between px-6 md:px-0 py-10 md:py-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 m-auto gap-5 w-full">
          <div className="w-full md:w-[405] h-auto md:h-[316] flex flex-col bg-[#F4F6FC] gap-3 p-7 md:p-10 md:hover:shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] transition-all duration-500">
