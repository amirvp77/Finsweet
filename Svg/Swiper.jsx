        ...
        <div className="relative w-full md:w-[843]">
            ...
            >
                <SwiperSlide>
                    <div className="relative w-full h-full p-[48]">
                        <p className="text-2xl leading-relaxed">
                            ...
                            They understand our product and are able to
                ...
                <SwiperSlide>
                    <div className="relative w-full h-full p-[48]">
                        <p className="text-2xl leading-relaxed">
                            "Working with this team was an amazing
                ...
                <SwiperSlide>
                    <div className="relative w-full h-full p-[48]">
                        <p className="text-2xl leading-relaxed">
                            "They delivered everything we needed
                ...
                <SwiperSlide>
                    <div className="relative w-full h-full p-[48]">
                        <p className="text-2xl leading-relaxed">
                            "A great team with excellent communication
            ...
            <div className="absolute bottom-[48] right-[48] z-10 flex gap-4">
                <button
                    ref={prevRef}
                    className="w-[48] h-[48] rounded-full flex items-center justify-center bg-white text-black cursor-pointer"
                >
                    <HiArrowLongLeft size={24} />
                </button>
                <button
                    ref={nextRef}
                    className="w-[48] h-[48] rounded-full flex items-center justify-center bg-[#1C1E53] text-white cursor-pointer"
                >
