    ...
    <>
      <section className="w-full h-auto md:h-[1191] bg-[#F4F6FC] flex flex-col py-10 md:py-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 m-auto gap-5 px-5 md:px-0">
          <div className="w-full md:w-[405] h-auto md:h-[316] flex flex-col bg-white gap-3 p-7 md:p-10 md:hover:shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] transition-all duration-500">
