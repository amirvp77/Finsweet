    ...
    <section className="w-full md:w-[1280] h-auto md:h-[728] m-auto flex flex-col justify-center gap-8 px-4 md:px-0">
      ...
      <div className="w-full flex flex-col md:flex-row gap-3 md:gap-6">
        ...
        <div className="flex flex-row md:flex-col gap-3 md:gap-6 w-full md:w-[414]">
          <div className="w-full h-[150] md:h-[284] relative bg-[url('/Card3.png')] bg-cover bg-center overflow-hidden hover:shadow-2xl transition-all duration-600">
            <div className="absolute inset-0 bg-[#1C1E536B]"></div>

            <div className="absolute inset-0 p-4 md:p-8 flex flex-col gap-2 justify-end md:justify-center md:mt-30 text-white z-10">

              <h3 className="text-sm md:text-xl font-bold leading-tight">
                Unisaas Website <br className="hidden md:block" /> Design
              </h3>

              <a
                className="flex items-center text-xs md:text-base text-amber-300 group gap-2"
                href="#"
              >
                View More
                <HiArrowLongRight className="text-amber-300 text-lg md:text-2xl w-[24] transition-all duration-300 group-hover:translate-x-2" />
              </a>
            </div>
          </div>
