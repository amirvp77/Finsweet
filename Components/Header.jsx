  ...
  return (
    <header className="w-full h-[92] bg-[#1C1E53] relative z-50">
      <div className="flex items-center justify-between md:ml-15 md:justify-between py-6 px-7 text-white">
        ...
        <nav className="absolute top-[92] right-0 w-[250] bg-[#1C1E53] border-2 border-[#5B4BFF] rounded-[10] flex flex-col items-start gap-2 p-3 z-50 translate-x-[120%] peer-checked:translate-x-0 transition-transform duration-500 ease-in-out md:static md:w-auto md:border-0 md:rounded-none md:p-0 md:translate-x-0 md:flex-row md:items-center md:gap-15 md:bg-transparent">
          <Link
            href="/"
          ...
          <Link href="/Contact">
            <button className="hidden md:block cursor-pointer relative bg-white/10 py-2 rounded-full min-w-[8.5rem] min-h-[2.92rem] group max-w-full flex items-center justify-start hover:bg-[#FCD980] transition-all duration-[0.8s] ease-[cubic-bezier(0.510,0.026,0.368,1.016)] shadow-[inset_1px_2px_5px_#00000080]">
              <div className="absolute flex px-1 py-0.5 justify-start items-center inset-0">
                ...
                <div className="rounded-full shrink-0 flex justify-center items-center shadow-[inset_1px_-1px_3px_0_black] h-full aspect-square bg-[#FCD980] transition-all duration-[1s] ease-[cubic-bezier(0.510,0.026,0.368,1.016)] group-hover:bg-black">
